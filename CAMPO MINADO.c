...
//procedimento para sortear numeros
...
/*
    função que diz se um par de coordenadas eh vlaido ou nao
    1 - eh valido
    0 - nao eh valido
 */
...
/*
    função que retorna a qunatidade de bombas na vizinhança de l c
    n - qtd de bombas
*/
...
//procedimento para contar bombas vizinhas
void contarBombas(){
    for(l=0;l<tam;l++){
        for(c=0;c<tam;c++){
    ...
    do{
        ...
        do{
            ...
            if(coordenadaEhValida(linha, coluna) == 0 || jogo[linha][coluna].estaAberta == 1){
                printf("\nCoordenada invalida ou jah aberta!");
            }
